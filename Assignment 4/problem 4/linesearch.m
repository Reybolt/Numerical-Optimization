...
function [retcode, ax, af, ag, alpha] = linesearch(x, f, g, d, alphamax);

% define parameters
  
sigma   = 0.9;               %% Wolfe Powell parameter
rho     = 0.0001;            %% Goldstein parameter
...
[retcode, ax, af, ag, alpha] = bracketing(x, f, g, d, alphamax, sigma, rho, tau1, tau2, tau3, lowerbd);
